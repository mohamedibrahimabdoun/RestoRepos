...
import com.resto.pkh.MyFragmentB.EffictiveAdpterb;
...
public class MyFragmentA extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		for (int i = 1; i <= 10; i++) {
			...
			rest.setREST_ID(i);
			rest.setREST_IMAGE_NAME("NAME" + Integer.toString(i));
			rest.setREST_EMAIL("EMAIL" + Integer.toString(i) + "@x.com");
							...
							.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
								...
								public void onCheckedChanged(
									...
									if (element.isSelected() == true) {
										...
										String textPassToB = Integer.toString(element.getREST_ID());
										Log.d("before","before");
